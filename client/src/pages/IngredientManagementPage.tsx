            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="relative w-full sm:max-w-xs">
                ...
                <input
                  ...
                  className="border-background-300 text-text-950 focus:border-primary focus:ring-primary-100 w-full rounded-lg border bg-white py-2 pr-3 pl-9 text-sm outline-none focus:ring"
                />
              </div>
            </div>
                      ...
                      {isEditing ? (
                        ...
                        >
                          ...
                          <input
                            ...
                            className="border-background-300 text-text-950 focus:border-primary focus:ring-primary-100 min-w-0 flex-1 rounded-lg border bg-white px-3 py-2 outline-none focus:ring"
                          />
                          <div className="flex gap-2">
                            <button
                              type="submit"
