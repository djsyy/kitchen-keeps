          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="border-background-200 border-b pb-6 last:border-b-0 last:pb-0">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <button
                  type="button"
                  className="bg-brick-red-600 text-text-50 hover:bg-brick-red-700 w-fit rounded-md px-4 py-2 text-sm font-bold transition disabled:cursor-not-allowed disabled:opacity-60"
